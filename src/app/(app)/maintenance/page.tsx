    ...
    <div className="max-w-7xl px-4 py-6 md:px-10 md:py-8">
      ...
      <section className="mb-8">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/maintenance/projects" className="inline-flex items-center gap-1 text-xs font-semibold text-blue-600 hover:text-blue-700">
            Ver todos
            <ArrowRight className="size-3.5" />
          </Link>
        </div>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <MacroKpi label="Activos" value={activeProjects.length} icon={Wrench} accent="#0F172A" href="/maintenance/projects" />
          <MacroKpi label="En progreso" value={inProgress.length} icon={Clock} accent="#2563EB" href="/maintenance/projects" />
