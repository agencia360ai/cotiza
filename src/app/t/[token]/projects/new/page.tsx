...
export default async function NewTechnicianProjectPage({
  params,
}: {
    ...
    <div className="mx-auto max-w-2xl px-5 py-6 sm:py-10">
      ...
      <header className="mb-8">
        ...
        <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-900">
          ¿Qué obra estás arrancando?
        </h1>
        <p className="mt-2 text-sm text-slate-500">
          Elegí cliente y sucursal. Después vas cargando los hitos paso a paso, con foto y video.
        </p>
      </header>

      <NewProjectWizard token={token} clients={data.clients} />
    </div>
  );
}
